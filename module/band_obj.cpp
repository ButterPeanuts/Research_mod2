...
band_obj::band_obj(mc_sim::logger& newlogger, curve dos, curve gvelocity, wave_direction direction, wave_mode mode, scatconst bands_scatconst) : dos(dos), gvelocity(gvelocity), bands_scatconst(bands_scatconst), logger(newlogger){
