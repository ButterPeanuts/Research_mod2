...
class physconst {
	...
	public:
		...
		*/
		static std::pair<bool, double> vonNeumann_rejection(const std::function<double(double)>& f, const std::uniform_real_distribution<>& xdist, const std::uniform_real_distribution<>& fdist, std::mt19937_64& engine);
