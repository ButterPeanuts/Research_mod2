...
int main(){
	...
	std::shared_ptr<logger> tados_logger(logobj.copy_samesink("LA_dos_logger"));
	std::shared_ptr<logger> tagv_logger(logobj.copy_samesink("LA_gv_logger"));
	std::shared_ptr<logger> tascat_logger(logobj.copy_samesink("LA_scat_logger"));
